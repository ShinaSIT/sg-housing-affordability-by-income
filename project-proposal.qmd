...
ggtexttable(head(income_raw_wide, 6))
...
ggtexttable(head(cpi_monthly_raw, 6))
...
ggtexttable(head(hdb_rpi_quarterly, 6))
...
grid.table(head(real_income_display, 10))
```
...
Growth differentials will also be compared across income groups to assess whether affordability divergence is widening structurally over time.
